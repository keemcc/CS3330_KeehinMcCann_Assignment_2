...
/**
 * Wizard is a type of MiddleEarthCharacter that has specific attack advantages and disadvantages
 */
public class Wizard extends MiddleEarthCharacter{
	...
	/**
	 * Implementation of the attack method with the Wizard's specific advantages and disadvantages
	 * Prints attack, whether it was effective or not, and how much health was lost, if any.
	 */
	@Override
	public boolean attack(MiddleEarthCharacter target) {
		System.out.println(this.getName() + " attacks " + target.getName() + "!");
		//The Wizard will do no damage to these races
		...
		//The Wizard will do 1.5 times damage to this race
	...
	/**
	 * Implementation of the getRace method to return "Wizard"
	 */
	@Override
